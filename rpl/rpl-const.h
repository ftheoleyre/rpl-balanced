...
#define MAX_ELT						FLT_MAX 			//max lifetime if I have battery full (880 mAh in Joule) and I transmit at a rate of 250 kb/s
...
#define VERIFY_BOTTLENECK			300000000000
...
//constants for Energy (ETX + residual energy)
#define ALPHA_ENERGY				0.5  //the value of the weight for the metric
#define MAX_ENERGY					12672
#define MAX_ETX						9
...
#define START_TIME	3600000000000 //3600000000000  //stats should be computed only START_TIME seconds after the beginning of the simulation
