...
typedef struct{
	int neighbor;
	int packs_net; //nr of packets received from network layer (RPL)
	int packs_tx;
...
typedef struct {
	...
	//information about retransmission to send to RPL
	etx_elt_t *neigh_retransmit;
	 
	//time at which I received the last ack - will trigger RPL to re-choose its preferred parent 
